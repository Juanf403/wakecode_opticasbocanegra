...
if ( isset($_POST['nombre']) ){
	...
	if ( mysql_query("INSERT INTO articulos SET articulo='".$nombre."',idcategoria='".$categoria."',precio='".$precio."',stock='".$stock."',alerta='".$alerta."',descripcion='".$descripcion."',observaciones='".$observaciones."',costo='".$costo."'") ){
...
?>
										<option value="<?php echo $q->idcategorias; ?>"><?php echo $q->tipo." - ".$q->categoria; ?></option>
<?php
									}
?>
							</select>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-3"><input type="text" name="costo" class="form-control" placeholder=""></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6"><input type="text" name="alerta" class="form-control" placeholder=""></div>
									</div>
								</div>
							</div>
