...
if ( isset($_POST['cliente']) ){
	...
	mysql_query("INSERT INTO ventas SET fecha='".$fecha."',hora='".$hora."',idcliente='".$cliente."',venta='".$venta."',descuento='".$descuento."',idusuario='".$_SESSION['userId']."'") or die(mysql_error());
