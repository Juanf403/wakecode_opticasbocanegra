		...
		<div class="col-md-6">
			<form class="" method="get" action="">
				...
				<div class="input-group">
					<input type="text" class="input-md form-control" value="<?php echo @$_GET['buscar']; ?>" name="buscar" placeholder="Buscar por nombre, correo, telefono"> <span class="input-group-btn"> <button type="submit" class="btn btn-md btn-default"> <i class="fa fa-search"></i> </button> </span>
				</div>
			</form>
		</div>
	</div>
...
?>
					...
					<td class="text-right">
						<a href="admin.php?m=clienteCitas&id=<?php echo $q->idclientes; ?>" class="btn btn-sm btn-info"> <i class="fa fa-calendar"></i> </a> &nbsp;
						<?php
						...
						?>
						<a href="admin.php?m=clientesEditar&id=<?php echo $q->idclientes; ?>&buscar=<?php echo @$_GET['buscar']; ?>" class="btn btn-sm btn-default"> <i class="fa fa-pencil"></i> </a> &nbsp;
