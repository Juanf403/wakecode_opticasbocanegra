...
if ( isset($_POST['fecha']) ){
	...
	if ( mysql_query("UPDATE citas SET fecha='".$fecha."',hora='".$hora."',idcliente='".$cliente."',descripcion='".$desc."' WHERE idcitas='".$id."'")){
...
$data = mysql_fetch_object(mysql_query("SELECT * FROM citas JOIN clientes ON clientes.idclientes=citas.idcliente WHERE idcitas='".$id."' LIMIT 1"));
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 ">
									<input class="datepicker-input form-control" name="fecha" type="text" value="<?php echo $data->fecha; ?>" data-date-format="yyyy-mm-dd">
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-3 col-md-3 control-label">Hora de Visita</label>
								<div class="col-lg-9 col-md-9 "><input type="text" name="hora" class="form-control" value="<?php echo $data->hora; ?>"></div>
							</div>							
							<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 "><textarea name="desc" class="form-control" style="height:200px;"><?php echo $data->descripcion; ?></textarea></div>
							</div>
						</div>	
					</div>
